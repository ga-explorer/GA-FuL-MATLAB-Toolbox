...
function outMv = gpKv1Kv3Mv(inMv1, inMv2)
    ...
    outMv(7,:) = -inMv1(3,:) .* inMv2(1,:) - inMv1(4,:) .* inMv2(2,:);
    outMv(8,:) = inMv1(2,:) .* inMv2(1,:) - inMv1(4,:) .* inMv2(3,:);
    outMv(9,:) = -inMv1(1,:) .* inMv2(1,:) - inMv1(4,:) .* inMv2(4,:);
    outMv(10,:) = inMv1(2,:) .* inMv2(2,:) + inMv1(3,:) .* inMv2(3,:);
    outMv(11,:) = -inMv1(1,:) .* inMv2(2,:) + inMv1(3,:) .* inMv2(4,:);
    outMv(12,:) = -inMv1(1,:) .* inMv2(3,:) - inMv1(2,:) .* inMv2(4,:);

...
function outMv = lcpMvMvMv(inMv1, inMv2)
    ...
    outMv(2,:) = inMv1(1,:) .* inMv2(2,:) + inMv1(3,:) .* inMv2(6,:) + inMv1(4,:) .* inMv2(7,:) - inMv1(8,:) .* inMv2(12,:);
    outMv(3,:) = inMv1(1,:) .* inMv2(3,:) - inMv1(2,:) .* inMv2(6,:) + inMv1(4,:) .* inMv2(8,:) + inMv1(7,:) .* inMv2(12,:);
    outMv(4,:) = inMv1(1,:) .* inMv2(4,:) - inMv1(2,:) .* inMv2(7,:) - inMv1(3,:) .* inMv2(8,:) - inMv1(6,:) .* inMv2(12,:);
    ...
    outMv(6,:) = inMv1(1,:) .* inMv2(6,:) - inMv1(4,:) .* inMv2(12,:);
    outMv(7,:) = inMv1(1,:) .* inMv2(7,:) + inMv1(3,:) .* inMv2(12,:);
    outMv(8,:) = inMv1(1,:) .* inMv2(8,:) - inMv1(2,:) .* inMv2(12,:);

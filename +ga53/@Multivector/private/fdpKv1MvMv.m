...
function outMv = fdpKv1MvMv(inMv1, inMv2)
    ...
    outMv(2,:) = inMv1(1,:) .* inMv2(1,:) + inMv1(2,:) .* inMv2(10,:) + inMv1(3,:) .* inMv2(11,:) - inMv1(4,:) .* inMv2(13,:) - inMv1(5,:) .* inMv2(16,:) - inMv1(6,:) .* inMv2(20,:) - inMv1(7,:) .* inMv2(25,:) - inMv1(8,:) .* inMv2(31,:);
    outMv(3,:) = -inMv1(1,:) .* inMv2(10,:) + inMv1(2,:) .* inMv2(1,:) + inMv1(3,:) .* inMv2(12,:) - inMv1(4,:) .* inMv2(14,:) - inMv1(5,:) .* inMv2(17,:) - inMv1(6,:) .* inMv2(21,:) - inMv1(7,:) .* inMv2(26,:) - inMv1(8,:) .* inMv2(32,:);
    outMv(4,:) = -inMv1(1,:) .* inMv2(11,:) - inMv1(2,:) .* inMv2(12,:) + inMv1(3,:) .* inMv2(1,:) - inMv1(4,:) .* inMv2(15,:) - inMv1(5,:) .* inMv2(18,:) - inMv1(6,:) .* inMv2(22,:) - inMv1(7,:) .* inMv2(27,:) - inMv1(8,:) .* inMv2(33,:);
    outMv(5,:) = -inMv1(1,:) .* inMv2(13,:) - inMv1(2,:) .* inMv2(14,:) - inMv1(3,:) .* inMv2(15,:) + inMv1(4,:) .* inMv2(1,:) - inMv1(5,:) .* inMv2(19,:) - inMv1(6,:) .* inMv2(23,:) - inMv1(7,:) .* inMv2(28,:) - inMv1(8,:) .* inMv2(34,:);
    outMv(6,:) = -inMv1(1,:) .* inMv2(16,:) - inMv1(2,:) .* inMv2(17,:) - inMv1(3,:) .* inMv2(18,:) + inMv1(4,:) .* inMv2(19,:) + inMv1(5,:) .* inMv2(1,:) - inMv1(6,:) .* inMv2(24,:) - inMv1(7,:) .* inMv2(29,:) - inMv1(8,:) .* inMv2(35,:);
    outMv(7,:) = -inMv1(1,:) .* inMv2(20,:) - inMv1(2,:) .* inMv2(21,:) - inMv1(3,:) .* inMv2(22,:) + inMv1(4,:) .* inMv2(23,:) + inMv1(5,:) .* inMv2(24,:) + inMv1(6,:) .* inMv2(1,:) - inMv1(7,:) .* inMv2(30,:) - inMv1(8,:) .* inMv2(36,:);
    outMv(8,:) = -inMv1(1,:) .* inMv2(25,:) - inMv1(2,:) .* inMv2(26,:) - inMv1(3,:) .* inMv2(27,:) + inMv1(4,:) .* inMv2(28,:) + inMv1(5,:) .* inMv2(29,:) + inMv1(6,:) .* inMv2(30,:) + inMv1(7,:) .* inMv2(1,:) - inMv1(8,:) .* inMv2(37,:);
    outMv(9,:) = -inMv1(1,:) .* inMv2(31,:) - inMv1(2,:) .* inMv2(32,:) - inMv1(3,:) .* inMv2(33,:) + inMv1(4,:) .* inMv2(34,:) + inMv1(5,:) .* inMv2(35,:) + inMv1(6,:) .* inMv2(36,:) + inMv1(7,:) .* inMv2(37,:) + inMv1(8,:) .* inMv2(1,:);

...
function outMv = lcpMvMvMv(inMv1, inMv2)
    ...
    outMv(2,:) = inMv1(1,:) .* inMv2(2,:) - inMv1(6,:) .* inMv2(13,:);
    outMv(3,:) = inMv1(1,:) .* inMv2(3,:) - inMv1(2,:) .* inMv2(7,:) - inMv1(6,:) .* inMv2(14,:) - inMv1(13,:) .* inMv2(21,:);
    outMv(4,:) = inMv1(1,:) .* inMv2(4,:) - inMv1(2,:) .* inMv2(8,:) - inMv1(6,:) .* inMv2(15,:) - inMv1(13,:) .* inMv2(22,:);
    outMv(5,:) = inMv1(1,:) .* inMv2(5,:) - inMv1(2,:) .* inMv2(10,:) - inMv1(6,:) .* inMv2(16,:) - inMv1(13,:) .* inMv2(24,:);
    outMv(6,:) = inMv1(1,:) .* inMv2(6,:) - inMv1(2,:) .* inMv2(13,:);
    outMv(7,:) = inMv1(1,:) .* inMv2(7,:) + inMv1(6,:) .* inMv2(21,:);
    outMv(8,:) = inMv1(1,:) .* inMv2(8,:) + inMv1(6,:) .* inMv2(22,:);
    ...
    outMv(15,:) = inMv1(1,:) .* inMv2(15,:) - inMv1(2,:) .* inMv2(22,:);

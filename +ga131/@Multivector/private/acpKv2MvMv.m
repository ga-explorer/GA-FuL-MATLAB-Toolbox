...
function outMv = acpKv2MvMv(inMv1, inMv2)
    ...
    outMv(2,:) = -inMv1(3,:) .* inMv2(17,:) + inMv1(8,:) .* inMv2(21,:) + inMv1(9,:) .* inMv2(22,:);
    outMv(3,:) = inMv1(2,:) .* inMv2(17,:) - inMv1(7,:) .* inMv2(21,:) + inMv1(9,:) .* inMv2(23,:);
    outMv(4,:) = -inMv1(1,:) .* inMv2(17,:) - inMv1(7,:) .* inMv2(22,:) - inMv1(8,:) .* inMv2(23,:);
    ...
    outMv(7,:) = inMv1(1,:) .* inMv2(1,:) + inMv1(9,:) .* inMv2(28,:);
    outMv(8,:) = inMv1(2,:) .* inMv2(1,:) - inMv1(8,:) .* inMv2(28,:);
    outMv(9,:) = inMv1(3,:) .* inMv2(1,:) + inMv1(7,:) .* inMv2(28,:);
    ...
    outMv(13,:) = -inMv1(3,:) .* inMv2(28,:) + inMv1(7,:) .* inMv2(1,:);
    outMv(14,:) = inMv1(2,:) .* inMv2(28,:) + inMv1(8,:) .* inMv2(1,:);
    outMv(15,:) = -inMv1(1,:) .* inMv2(28,:) + inMv1(9,:) .* inMv2(1,:);

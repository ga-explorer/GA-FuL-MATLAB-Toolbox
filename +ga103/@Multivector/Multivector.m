        ...
        function outMv = sp(inMv1, inMv2)
            ...
            switch inMv1.Grade
                case 0
                    switch inMv2.Grade
                        case 0
                            outMv = ga103.Multivector(0, spKv0Kv0Kv0(inMv1.Data, inMv2.Data));
                        case 1
                            outMv = ga103.Multivector(0, spKv0Kv1Kv0(inMv1.Data, inMv2.Data));
                        case 2
                            outMv = ga103.Multivector(0, spKv0Kv2Kv0(inMv1.Data, inMv2.Data));
                        case 3
                            outMv = ga103.Multivector(0, spKv0Kv3Kv0(inMv1.Data, inMv2.Data));
                        case 4
                            outMv = ga103.Multivector(0, spKv0Kv4Kv0(inMv1.Data, inMv2.Data));
                        otherwise
                            outMv = ga103.Multivector(0, spKv0MvKv0(inMv1.Data, inMv2.Data));
                    end
                    
                case 1
                    switch inMv2.Grade
                        case 0
                            outMv = ga103.Multivector(0, spKv1Kv0Kv0(inMv1.Data, inMv2.Data));
                        case 1
                            outMv = ga103.Multivector(0, spKv1Kv1Kv0(inMv1.Data, inMv2.Data));
                        case 2
                            outMv = ga103.Multivector(0, spKv1Kv2Kv0(inMv1.Data, inMv2.Data));
                        case 3
                            outMv = ga103.Multivector(0, spKv1Kv3Kv0(inMv1.Data, inMv2.Data));
                        case 4
                            outMv = ga103.Multivector(0, spKv1Kv4Kv0(inMv1.Data, inMv2.Data));
                        otherwise
                            outMv = ga103.Multivector(0, spKv1MvKv0(inMv1.Data, inMv2.Data));
                    end
                    
                case 2
                    switch inMv2.Grade
                        case 0
                            outMv = ga103.Multivector(0, spKv2Kv0Kv0(inMv1.Data, inMv2.Data));
                        case 1
                            outMv = ga103.Multivector(0, spKv2Kv1Kv0(inMv1.Data, inMv2.Data));
                        case 2
                            outMv = ga103.Multivector(0, spKv2Kv2Kv0(inMv1.Data, inMv2.Data));
                        case 3
                            outMv = ga103.Multivector(0, spKv2Kv3Kv0(inMv1.Data, inMv2.Data));
                        case 4
                            outMv = ga103.Multivector(0, spKv2Kv4Kv0(inMv1.Data, inMv2.Data));
                        otherwise
                            outMv = ga103.Multivector(0, spKv2MvKv0(inMv1.Data, inMv2.Data));
                    end
                    
                case 3
                    switch inMv2.Grade
                        case 0
                            outMv = ga103.Multivector(0, spKv3Kv0Kv0(inMv1.Data, inMv2.Data));
                        case 1
                            outMv = ga103.Multivector(0, spKv3Kv1Kv0(inMv1.Data, inMv2.Data));
                        case 2
                            outMv = ga103.Multivector(0, spKv3Kv2Kv0(inMv1.Data, inMv2.Data));
                        case 3
                            outMv = ga103.Multivector(0, spKv3Kv3Kv0(inMv1.Data, inMv2.Data));
                        case 4
                            outMv = ga103.Multivector(0, spKv3Kv4Kv0(inMv1.Data, inMv2.Data));
                        otherwise
                            outMv = ga103.Multivector(0, spKv3MvKv0(inMv1.Data, inMv2.Data));
                    end
                    
                case 4
                    switch inMv2.Grade
                        case 0
                            outMv = ga103.Multivector(0, spKv4Kv0Kv0(inMv1.Data, inMv2.Data));
                        case 1
                            outMv = ga103.Multivector(0, spKv4Kv1Kv0(inMv1.Data, inMv2.Data));
                        case 2
                            outMv = ga103.Multivector(0, spKv4Kv2Kv0(inMv1.Data, inMv2.Data));
                        case 3
                            outMv = ga103.Multivector(0, spKv4Kv3Kv0(inMv1.Data, inMv2.Data));
                        case 4
                            outMv = ga103.Multivector(0, spKv4Kv4Kv0(inMv1.Data, inMv2.Data));
                        otherwise
                            outMv = ga103.Multivector(0, spKv4MvKv0(inMv1.Data, inMv2.Data));
                    end
                    
                otherwise
                    switch inMv2.Grade
                        case 0
                            outMv = ga103.Multivector(0, spMvKv0Kv0(inMv1.Data, inMv2.Data));
                        case 1
                            outMv = ga103.Multivector(0, spMvKv1Kv0(inMv1.Data, inMv2.Data));
                        case 2
                            outMv = ga103.Multivector(0, spMvKv2Kv0(inMv1.Data, inMv2.Data));
                        case 3
                            outMv = ga103.Multivector(0, spMvKv3Kv0(inMv1.Data, inMv2.Data));
                        case 4
                            outMv = ga103.Multivector(0, spMvKv4Kv0(inMv1.Data, inMv2.Data));
                        otherwise
                            outMv = ga103.Multivector(0, spMvMvKv0(inMv1.Data, inMv2.Data));
                    end

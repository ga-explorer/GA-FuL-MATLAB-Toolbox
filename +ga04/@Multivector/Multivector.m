...
classdef Multivector
    ...
    methods
        ...
        function outMv = getScalarPart(inMv)
            ...
            outMv = ga04.Multivector(0, inMv.SampleCount);
        ...
        function outMv = getVectorPart(inMv)
            ...
            outMv = ga04.Multivector(1, inMv.SampleCount);
        ...
        function outMv = getBivectorPart(inMv)
            ...
            outMv = ga04.Multivector(2, inMv.SampleCount);
        ...
        function outMv = getTrivectorPart(inMv)
            ...
            outMv = ga04.Multivector(3, inMv.SampleCount);
        ...
        function outMv = get4VectorPart(inMv)
            ...
            outMv = ga04.Multivector(4, inMv.SampleCount);
        ...
        function outMv = getKVectorPart(inMv, grade)
            ...
            outMv = ga04.Multivector(grade, inMv.SampleCount);
        ...
        function outMv = uplus(inMv)
            ...
            outMv = ga04.Multivector(inMv.Grade, inMv.SampleCount);
            outMv.Data = inMv.Data;
        end
        ...
        function outMv = dual(inMv)
            ...
            switch inMv1.Grade
                ...
                case 1
                    outMv = ga04.Multivector(3, inMv.SampleCount);
                    outMv.Data = dualKv1Kv3(inMv.Data);
                case 2
                    outMv = ga04.Multivector(2, inMv.SampleCount);
                    outMv.Data = dualKv2Kv2(inMv.Data);
                case 3
                    outMv = ga04.Multivector(1, inMv.SampleCount);
                    outMv.Data = dualKv3Kv1(inMv.Data);
                case 4
                    outMv = ga04.Multivector(0, inMv.SampleCount);
                    outMv.Data = dualKv4Kv0(inMv.Data);
                otherwise
                    outMv = ga04.Multivector(-1, inMv.SampleCount);
        ...
        function outMv = unDual(inMv)
            ...
            switch inMv1.Grade
                ...
                case 2
                    outMv = ga04.Multivector(2, inMv.SampleCount);
                    outMv.Data = unDualKv2Kv2(inMv.Data);
                case 3
                    outMv = ga04.Multivector(1, inMv.SampleCount);
                    outMv.Data = unDualKv3Kv1(inMv.Data);
                case 4
                    outMv = ga04.Multivector(0, inMv.SampleCount);
        ...
        function outMv = plus(inMv1, inMv2)
            ...
            if (inMv1.Grade == inMv2.Grade)
                outMv = ga04.Multivector(inMv1.Grade, inMv1.SampleCount);
                outMv.Data = inMv1.Data + inMv2.Data;
            else
                outMv = ga04.Multivector(-1, inMv1.SampleCount);
        ...
        function outMv = sp(inMv1, inMv2)
            ...
            switch inMv1.Grade
                case 0
                    switch inMv2.Grade
                        case 0
                            outMv = ga04.Multivector(0, inMv1.SampleCount);
            ...
            switch inMv1.Grade
                case 0
                    switch inMv2.Grade
                        ...
                        case 2
                            outMv = ga04.Multivector(2, inMv1.SampleCount);
                            outMv.Data = opKv0Kv2Kv2(inMv1.Data, inMv2.Data);
                        case 3
                            outMv = ga04.Multivector(3, inMv1.SampleCount);
                            outMv.Data = opKv0Kv3Kv3(inMv1.Data, inMv2.Data);
                        case 4
                            outMv = ga04.Multivector(4, inMv1.SampleCount);
            ...
            switch inMv1.Grade
                ...
                case 2
                    switch inMv2.Grade
                        ...
                        case 4
                            outMv = ga04.Multivector(2, inMv1.SampleCount);
                            outMv.Data = gpKv2Kv4Kv2(inMv1.Data, inMv2.Data);
                        otherwise
                            outMv = ga04.Multivector(-1, inMv1.SampleCount);
                ...
                case 3
                    switch inMv2.Grade
                        ...
                        case 4
                            outMv = ga04.Multivector(1, inMv1.SampleCount);
                            outMv.Data = gpKv3Kv4Kv1(inMv1.Data, inMv2.Data);
                        otherwise
                            outMv = ga04.Multivector(-1, inMv1.SampleCount);
                ...
                case 4
                    switch inMv2.Grade
                        ...
                        case 2
                            outMv = ga04.Multivector(2, inMv1.SampleCount);
                            outMv.Data = gpKv4Kv2Kv2(inMv1.Data, inMv2.Data);
                        case 3
                            outMv = ga04.Multivector(1, inMv1.SampleCount);
                            outMv.Data = gpKv4Kv3Kv1(inMv1.Data, inMv2.Data);
                        case 4
                            outMv = ga04.Multivector(0, inMv1.SampleCount);

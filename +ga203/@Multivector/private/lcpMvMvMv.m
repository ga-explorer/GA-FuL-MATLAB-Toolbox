...
function outMv = lcpMvMvMv(inMv1, inMv2)
    ...
    outMv(3,:) = inMv1(1,:) .* inMv2(3,:) - inMv1(5,:) .* inMv2(11,:) - inMv1(6,:) .* inMv2(14,:) - inMv1(16,:) .* inMv2(25,:);
    outMv(4,:) = inMv1(1,:) .* inMv2(4,:) - inMv1(5,:) .* inMv2(12,:) - inMv1(6,:) .* inMv2(15,:) - inMv1(16,:) .* inMv2(26,:);
    outMv(5,:) = inMv1(1,:) .* inMv2(5,:) - inMv1(6,:) .* inMv2(16,:);
    outMv(6,:) = inMv1(1,:) .* inMv2(6,:) + inMv1(5,:) .* inMv2(16,:);
    ...
    outMv(11,:) = inMv1(1,:) .* inMv2(11,:) + inMv1(6,:) .* inMv2(25,:);
    outMv(12,:) = inMv1(1,:) .* inMv2(12,:) + inMv1(6,:) .* inMv2(26,:);
    outMv(13,:) = inMv1(1,:) .* inMv2(13,:) - inMv1(5,:) .* inMv2(24,:);
    outMv(14,:) = inMv1(1,:) .* inMv2(14,:) - inMv1(5,:) .* inMv2(25,:);

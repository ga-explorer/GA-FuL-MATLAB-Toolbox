classdef Multivector
    ...
    methods
        ...
        function outMv = getScalarPart(inMv)
            ...
            outMv = ga14.Multivector(0, inMv.SampleCount);
        ...
        function outMv = getVectorPart(inMv)
            ...
            outMv = ga14.Multivector(1, inMv.SampleCount);
        ...
        function outMv = getBivectorPart(inMv)
            ...
            outMv = ga14.Multivector(2, inMv.SampleCount);
        ...
        function outMv = getTrivectorPart(inMv)
            ...
            outMv = ga14.Multivector(3, inMv.SampleCount);
        ...
        function outMv = get4VectorPart(inMv)
            ...
            outMv = ga14.Multivector(4, inMv.SampleCount);
        ...
        function outMv = get5VectorPart(inMv)
            ...
            outMv = ga14.Multivector(5, inMv.SampleCount);
        ...
        function outMv = getKVectorPart(inMv, grade)
            ...
            outMv = ga14.Multivector(grade, inMv.SampleCount);
        ...
        function outMv = uplus(inMv)
            ...
            outMv = ga14.Multivector(inMv.Grade, inMv.SampleCount);
            outMv.Data = inMv.Data;
        end
        ...
        function outMv = dual(inMv)
            ...
            switch inMv1.Grade
                case 0
                    outMv = ga14.Multivector(5, inMv.SampleCount);
                    outMv.Data = dualKv0Kv5(inMv.Data);
                case 1
                    outMv = ga14.Multivector(4, inMv.SampleCount);
                    outMv.Data = dualKv1Kv4(inMv.Data);
                case 2
                    outMv = ga14.Multivector(3, inMv.SampleCount);
                    outMv.Data = dualKv2Kv3(inMv.Data);
                case 3
                    outMv = ga14.Multivector(2, inMv.SampleCount);
                    outMv.Data = dualKv3Kv2(inMv.Data);
                case 4
                    outMv = ga14.Multivector(1, inMv.SampleCount);
                    outMv.Data = dualKv4Kv1(inMv.Data);
                case 5
                    outMv = ga14.Multivector(0, inMv.SampleCount);
                    outMv.Data = dualKv5Kv0(inMv.Data);
                otherwise
                    outMv = ga14.Multivector(-1, inMv.SampleCount);
        ...
        function outMv = unDual(inMv)
            ...
            switch inMv1.Grade
                ...
                case 2
                    outMv = ga14.Multivector(3, inMv.SampleCount);
                    outMv.Data = unDualKv2Kv3(inMv.Data);
                case 3
                    outMv = ga14.Multivector(2, inMv.SampleCount);
                    outMv.Data = unDualKv3Kv2(inMv.Data);
                case 4
                    outMv = ga14.Multivector(1, inMv.SampleCount);
                    outMv.Data = unDualKv4Kv1(inMv.Data);
                case 5
                    outMv = ga14.Multivector(0, inMv.SampleCount);
        ...
        function outMv = plus(inMv1, inMv2)
            ...
            if (inMv1.Grade == inMv2.Grade)
                outMv = ga14.Multivector(inMv1.Grade, inMv1.SampleCount);
                outMv.Data = inMv1.Data + inMv2.Data;
            else
                outMv = ga14.Multivector(-1, inMv1.SampleCount);
        ...
        function outMv = sp(inMv1, inMv2)
            ...
            switch inMv1.Grade
                case 0
                    switch inMv2.Grade
                        case 0
                            outMv = ga14.Multivector(0, inMv1.SampleCount);
            ...
            switch inMv1.Grade
                case 0
                    switch inMv2.Grade
                        ...
                        case 2
                            outMv = ga14.Multivector(2, inMv1.SampleCount);
                            outMv.Data = opKv0Kv2Kv2(inMv1.Data, inMv2.Data);
                        case 3
                            outMv = ga14.Multivector(3, inMv1.SampleCount);
                            outMv.Data = opKv0Kv3Kv3(inMv1.Data, inMv2.Data);
                        case 4
                            outMv = ga14.Multivector(4, inMv1.SampleCount);
                            outMv.Data = opKv0Kv4Kv4(inMv1.Data, inMv2.Data);
                        case 5
                            outMv = ga14.Multivector(5, inMv1.SampleCount);
            ...
            switch inMv1.Grade
                ...
                case 3
                    switch inMv2.Grade
                        ...
                        case 3
                            outMv = ga14.Multivector(2, inMv1.SampleCount);
                            outMv.Data = cpKv3Kv3Kv2(inMv1.Data, inMv2.Data);
                        case 4
                            outMv = ga14.Multivector(1, inMv1.SampleCount);
                            outMv.Data = cpKv3Kv4Kv1(inMv1.Data, inMv2.Data);
                        case 5
                            outMv = ga14.Multivector(0, inMv1.SampleCount);
                ...
                case 4
                    switch inMv2.Grade
                        ...
                        case 3
                            outMv = ga14.Multivector(1, inMv1.SampleCount);
                            outMv.Data = cpKv4Kv3Kv1(inMv1.Data, inMv2.Data);
                        case 4
                            outMv = ga14.Multivector(2, inMv1.SampleCount);
                            outMv.Data = cpKv4Kv4Kv2(inMv1.Data, inMv2.Data);
                        case 5
                            outMv = ga14.Multivector(0, inMv1.SampleCount);
            ...
            switch inMv1.Grade
                ...
                case 2
                    switch inMv2.Grade
                        ...
                        case 4
                            outMv = ga14.Multivector(2, inMv1.SampleCount);
                            outMv.Data = acpKv2Kv4Kv2(inMv1.Data, inMv2.Data);
                        case 5
                            outMv = ga14.Multivector(3, inMv1.SampleCount);
                            outMv.Data = acpKv2Kv5Kv3(inMv1.Data, inMv2.Data);
                        otherwise
                            outMv = ga14.Multivector(-1, inMv1.SampleCount);
                ...
                case 3
                    switch inMv2.Grade
                        ...
                        case 4
                            outMv = ga14.Multivector(3, inMv1.SampleCount);
                            outMv.Data = acpKv3Kv4Kv3(inMv1.Data, inMv2.Data);
                        case 5
                            outMv = ga14.Multivector(2, inMv1.SampleCount);
                            outMv.Data = acpKv3Kv5Kv2(inMv1.Data, inMv2.Data);
                        otherwise
                            outMv = ga14.Multivector(-1, inMv1.SampleCount);
                ...
                case 4
                    switch inMv2.Grade
                        ...
                        case 2
                            outMv = ga14.Multivector(2, inMv1.SampleCount);
                            outMv.Data = acpKv4Kv2Kv2(inMv1.Data, inMv2.Data);
                        case 3
                            outMv = ga14.Multivector(3, inMv1.SampleCount);
                            outMv.Data = acpKv4Kv3Kv3(inMv1.Data, inMv2.Data);
                        case 4
                            outMv = ga14.Multivector(0, inMv1.SampleCount);
                            outMv.Data = acpKv4Kv4Kv0(inMv1.Data, inMv2.Data);
                        case 5
                            outMv = ga14.Multivector(1, inMv1.SampleCount);
                            outMv.Data = acpKv4Kv5Kv1(inMv1.Data, inMv2.Data);
                        otherwise
                            outMv = ga14.Multivector(-1, inMv1.SampleCount);
                ...
                case 5
                    switch inMv2.Grade
                        ...
                        case 2
                            outMv = ga14.Multivector(3, inMv1.SampleCount);
                            outMv.Data = acpKv5Kv2Kv3(inMv1.Data, inMv2.Data);
                        case 3
                            outMv = ga14.Multivector(2, inMv1.SampleCount);
                            outMv.Data = acpKv5Kv3Kv2(inMv1.Data, inMv2.Data);
                        case 4
                            outMv = ga14.Multivector(1, inMv1.SampleCount);
                            outMv.Data = acpKv5Kv4Kv1(inMv1.Data, inMv2.Data);
                        case 5
                            outMv = ga14.Multivector(0, inMv1.SampleCount);
            ...
            switch inMv1.Grade
                ...
                case 2
                    switch inMv2.Grade
                        ...
                        case 5
                            outMv = ga14.Multivector(3, inMv1.SampleCount);
                            outMv.Data = gpKv2Kv5Kv3(inMv1.Data, inMv2.Data);
                        otherwise
                            outMv = ga14.Multivector(-1, inMv1.SampleCount);
                ...
                case 3
                    switch inMv2.Grade
                        ...
                        case 5
                            outMv = ga14.Multivector(2, inMv1.SampleCount);
                            outMv.Data = gpKv3Kv5Kv2(inMv1.Data, inMv2.Data);
                        otherwise
                            outMv = ga14.Multivector(-1, inMv1.SampleCount);
                ...
                case 4
                    switch inMv2.Grade
                        ...
                        case 5
                            outMv = ga14.Multivector(1, inMv1.SampleCount);
                            outMv.Data = gpKv4Kv5Kv1(inMv1.Data, inMv2.Data);
                        otherwise
                            outMv = ga14.Multivector(-1, inMv1.SampleCount);
                ...
                case 5
                    switch inMv2.Grade
                        ...
                        case 2
                            outMv = ga14.Multivector(3, inMv1.SampleCount);
                            outMv.Data = gpKv5Kv2Kv3(inMv1.Data, inMv2.Data);
                        case 3
                            outMv = ga14.Multivector(2, inMv1.SampleCount);
                            outMv.Data = gpKv5Kv3Kv2(inMv1.Data, inMv2.Data);
                        case 4
                            outMv = ga14.Multivector(1, inMv1.SampleCount);
                            outMv.Data = gpKv5Kv4Kv1(inMv1.Data, inMv2.Data);
                        case 5
                            outMv = ga14.Multivector(0, inMv1.SampleCount);

function outMv = acpKv2MvMv(inMv1, inMv2)
    ...
    outMv(2,:) = -inMv1(3,:) .* inMv2(17,:) - inMv1(5,:) .* inMv2(18,:) - inMv1(6,:) .* inMv2(19,:);
    outMv(3,:) = inMv1(2,:) .* inMv2(17,:) + inMv1(4,:) .* inMv2(18,:) - inMv1(6,:) .* inMv2(20,:);
    outMv(4,:) = -inMv1(1,:) .* inMv2(17,:) + inMv1(4,:) .* inMv2(19,:) + inMv1(5,:) .* inMv2(20,:);
    ...
    outMv(7,:) = inMv1(1,:) .* inMv2(1,:) - inMv1(6,:) .* inMv2(27,:);
    outMv(8,:) = inMv1(2,:) .* inMv2(1,:) + inMv1(5,:) .* inMv2(27,:);
    outMv(9,:) = inMv1(3,:) .* inMv2(1,:) - inMv1(4,:) .* inMv2(27,:);
    outMv(10,:) = -inMv1(3,:) .* inMv2(27,:) + inMv1(4,:) .* inMv2(1,:);
    outMv(11,:) = inMv1(2,:) .* inMv2(27,:) + inMv1(5,:) .* inMv2(1,:);
    outMv(12,:) = -inMv1(1,:) .* inMv2(27,:) + inMv1(6,:) .* inMv2(1,:);

...
function outMv = lcpMvMvMv(inMv1, inMv2)
    ...
    outMv(3,:) = inMv1(1,:) .* inMv2(3,:) - inMv1(4,:) .* inMv2(8,:) - inMv1(5,:) .* inMv2(10,:) - inMv1(11,:) .* inMv2(15,:);
    outMv(4,:) = inMv1(1,:) .* inMv2(4,:) - inMv1(5,:) .* inMv2(11,:);
    outMv(5,:) = inMv1(1,:) .* inMv2(5,:) + inMv1(4,:) .* inMv2(11,:);
    ...
    outMv(10,:) = inMv1(1,:) .* inMv2(10,:) - inMv1(4,:) .* inMv2(15,:);

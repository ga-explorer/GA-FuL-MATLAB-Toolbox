...
function outMv = cpMvKv3Mv(inMv1, inMv2)
    ...
    outMv(8,:) = -inMv1(13,:) .* inMv2(3,:) + inMv1(14,:) .* inMv2(2,:);
    outMv(9,:) = -inMv1(12,:) .* inMv2(4,:) + inMv1(15,:) .* inMv2(1,:);
    outMv(10,:) = inMv1(12,:) .* inMv2(3,:) - inMv1(14,:) .* inMv2(1,:);
    outMv(11,:) = -inMv1(12,:) .* inMv2(2,:) + inMv1(13,:) .* inMv2(1,:);
    ...
    outMv(15,:) = -inMv1(6,:) .* inMv2(3,:) + inMv1(7,:) .* inMv2(2,:) - inMv1(9,:) .* inMv2(1,:);

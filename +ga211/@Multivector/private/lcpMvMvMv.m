...
function outMv = lcpMvMvMv(inMv1, inMv2)
    ...
    outMv(2,:) = inMv1(1,:) .* inMv2(2,:) - inMv1(4,:) .* inMv2(7,:) - inMv1(5,:) .* inMv2(9,:) - inMv1(11,:) .* inMv2(14,:);
    ...
    outMv(4,:) = inMv1(1,:) .* inMv2(4,:) - inMv1(2,:) .* inMv2(7,:) - inMv1(5,:) .* inMv2(11,:) - inMv1(9,:) .* inMv2(14,:);
    outMv(5,:) = inMv1(1,:) .* inMv2(5,:) - inMv1(2,:) .* inMv2(9,:) + inMv1(4,:) .* inMv2(11,:) + inMv1(7,:) .* inMv2(14,:);
    ...
    outMv(9,:) = inMv1(1,:) .* inMv2(9,:) - inMv1(4,:) .* inMv2(14,:);
    outMv(10,:) = inMv1(1,:) .* inMv2(10,:) - inMv1(2,:) .* inMv2(13,:) - inMv1(4,:) .* inMv2(15,:) - inMv1(7,:) .* inMv2(16,:);
    outMv(11,:) = inMv1(1,:) .* inMv2(11,:) - inMv1(2,:) .* inMv2(14,:);

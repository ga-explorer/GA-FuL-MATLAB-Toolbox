...
classdef Multivector
    ...
    methods
        ...
        function outMv = getScalarPart(inMv)
            ...
            outMv = ga11.Multivector(0, inMv.SampleCount);
        ...
        function outMv = getVectorPart(inMv)
            ...
            outMv = ga11.Multivector(1, inMv.SampleCount);
        ...
        function outMv = getBivectorPart(inMv)
            ...
            outMv = ga11.Multivector(2, inMv.SampleCount);
        ...
        function outMv = getKVectorPart(inMv, grade)
            ...
            outMv = ga11.Multivector(grade, inMv.SampleCount);
        ...
        function outMv = uplus(inMv)
            ...
            outMv = ga11.Multivector(inMv.Grade, inMv.SampleCount);
            outMv.Data = inMv.Data;
        end
        ...
        function outMv = dual(inMv)
            ...
            switch inMv1.Grade
                case 0
                    outMv = ga11.Multivector(2, inMv.SampleCount);
                    outMv.Data = dualKv0Kv2(inMv.Data);
                case 1
                    outMv = ga11.Multivector(1, inMv.SampleCount);
                    outMv.Data = dualKv1Kv1(inMv.Data);
                case 2
                    outMv = ga11.Multivector(0, inMv.SampleCount);
                    outMv.Data = dualKv2Kv0(inMv.Data);
                otherwise
                    outMv = ga11.Multivector(-1, inMv.SampleCount);
        ...
        function outMv = unDual(inMv)
            ...
            switch inMv1.Grade
                ...
                case 1
                    outMv = ga11.Multivector(1, inMv.SampleCount);
                    outMv.Data = unDualKv1Kv1(inMv.Data);
                case 2
                    outMv = ga11.Multivector(0, inMv.SampleCount);
        ...
        function outMv = plus(inMv1, inMv2)
            ...
            if (inMv1.Grade == inMv2.Grade)
                outMv = ga11.Multivector(inMv1.Grade, inMv1.SampleCount);
                outMv.Data = inMv1.Data + inMv2.Data;
            else
                outMv = ga11.Multivector(-1, inMv1.SampleCount);
        ...
        function outMv = sp(inMv1, inMv2)
            ...
            switch inMv1.Grade
                case 0
                    switch inMv2.Grade
                        case 0
                            outMv = ga11.Multivector(0, inMv1.SampleCount);
            ...
            switch inMv1.Grade
                case 0
                    switch inMv2.Grade
                        ...
                        case 2
                            outMv = ga11.Multivector(2, inMv1.SampleCount);
            ...
            switch inMv1.Grade
                ...
                case 2
                    switch inMv2.Grade
                        ...
                        otherwise
                            outMv = ga11.Multivector(1, inMv1.SampleCount);
                            outMv.Data = cpKv2MvKv1(inMv1.Data, inMv2.Data);
                    end
                ...
                otherwise
                    switch inMv2.Grade
                        ...
                        case 2
                            outMv = ga11.Multivector(1, inMv1.SampleCount);
                            outMv.Data = cpMvKv2Kv1(inMv1.Data, inMv2.Data);
                        otherwise
                            outMv = ga11.Multivector(-1, inMv1.SampleCount);
            ...
            switch inMv1.Grade
                ...
                case 1
                    switch inMv2.Grade
                        ...
                        case 2
                            outMv = ga11.Multivector(1, inMv1.SampleCount);
                            outMv.Data = gpKv1Kv2Kv1(inMv1.Data, inMv2.Data);
                        otherwise
                            outMv = ga11.Multivector(-1, inMv1.SampleCount);
                ...
                case 2
                    switch inMv2.Grade
                        ...
                        case 1
                            outMv = ga11.Multivector(1, inMv1.SampleCount);
                            outMv.Data = gpKv2Kv1Kv1(inMv1.Data, inMv2.Data);
                        case 2
                            outMv = ga11.Multivector(0, inMv1.SampleCount);

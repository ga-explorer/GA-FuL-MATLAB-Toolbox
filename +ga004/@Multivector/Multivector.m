...
classdef Multivector
    ...
    methods
        ...
        function outMv = getScalarPart(inMv)
            ...
            outMv = ga004.Multivector(0, inMv.SampleCount);
        ...
        function outMv = getVectorPart(inMv)
            ...
            outMv = ga004.Multivector(1, inMv.SampleCount);
        ...
        function outMv = getBivectorPart(inMv)
            ...
            outMv = ga004.Multivector(2, inMv.SampleCount);
        ...
        function outMv = getTrivectorPart(inMv)
            ...
            outMv = ga004.Multivector(3, inMv.SampleCount);
        ...
        function outMv = get4VectorPart(inMv)
            ...
            outMv = ga004.Multivector(4, inMv.SampleCount);
        ...
        function outMv = getKVectorPart(inMv, grade)
            ...
            outMv = ga004.Multivector(grade, inMv.SampleCount);
        ...
        function outMv = uplus(inMv)
            ...
            outMv = ga004.Multivector(inMv.Grade, inMv.SampleCount);
            outMv.Data = inMv.Data;
        end
        ...
        function outMv = unDual(inMv)
            ...
            switch inMv1.Grade
                ...
                otherwise
                    outMv = ga004.Multivector(4, inMv.SampleCount);
                    outMv.Data = unDualMvKv4(inMv.Data);
            end
        ...
        function outMv = plus(inMv1, inMv2)
            ...
            if (inMv1.Grade == inMv2.Grade)
                outMv = ga004.Multivector(inMv1.Grade, inMv1.SampleCount);
                outMv.Data = inMv1.Data + inMv2.Data;
            else
                outMv = ga004.Multivector(-1, inMv1.SampleCount);
        ...
        function outMv = sp(inMv1, inMv2)
            ...
            switch inMv1.Grade
                case 0
                    switch inMv2.Grade
                        case 0
                            outMv = ga004.Multivector(0, inMv1.SampleCount);
            ...
            switch inMv1.Grade
                case 0
                    switch inMv2.Grade
                        ...
                        case 2
                            outMv = ga004.Multivector(2, inMv1.SampleCount);
                            outMv.Data = opKv0Kv2Kv2(inMv1.Data, inMv2.Data);
                        case 3
                            outMv = ga004.Multivector(3, inMv1.SampleCount);
                            outMv.Data = opKv0Kv3Kv3(inMv1.Data, inMv2.Data);
                        case 4
                            outMv = ga004.Multivector(4, inMv1.SampleCount);
            ...
            switch inMv1.Grade
                ...
                case 3
                    switch inMv2.Grade
                        ...
                        otherwise
                            outMv = ga004.Multivector(3, inMv1.SampleCount);
                            outMv.Data = acpKv3MvKv3(inMv1.Data, inMv2.Data);
                    end
                ...
                otherwise
                    switch inMv2.Grade
                        ...
                        case 3
                            outMv = ga004.Multivector(3, inMv1.SampleCount);
                            outMv.Data = acpMvKv3Kv3(inMv1.Data, inMv2.Data);
                        case 4
                            outMv = ga004.Multivector(4, inMv1.SampleCount);
            ...
            switch inMv1.Grade
                ...
                case 1
                    switch inMv2.Grade
                        ...
                        case 4
                            outMv = ga004.Multivector(0, inMv1.SampleCount);
                            outMv.Data = gpKv1Kv4Kv0(inMv1.Data, inMv2.Data);
                        otherwise
                            outMv = ga004.Multivector(-1, inMv1.SampleCount);
                ...
                case 2
                    switch inMv2.Grade
                        ...
                        case 3
                            outMv = ga004.Multivector(0, inMv1.SampleCount);
                            outMv.Data = gpKv2Kv3Kv0(inMv1.Data, inMv2.Data);
                        case 4
                            outMv = ga004.Multivector(0, inMv1.SampleCount);
                ...
                case 3
                    switch inMv2.Grade
                        ...
                        case 2
                            outMv = ga004.Multivector(0, inMv1.SampleCount);
                            outMv.Data = gpKv3Kv2Kv0(inMv1.Data, inMv2.Data);
                        case 3
                            outMv = ga004.Multivector(0, inMv1.SampleCount);
                ...
                case 4
                    switch inMv2.Grade
                        ...
                        case 1
                            outMv = ga004.Multivector(0, inMv1.SampleCount);
                            outMv.Data = gpKv4Kv1Kv0(inMv1.Data, inMv2.Data);
                        case 2
                            outMv = ga004.Multivector(0, inMv1.SampleCount);
                        ...
                        otherwise
                            outMv = ga004.Multivector(4, inMv1.SampleCount);
                            outMv.Data = gpKv4MvKv4(inMv1.Data, inMv2.Data);
                    end
                ...
                otherwise
                    switch inMv2.Grade
                        ...
                        case 4
                            outMv = ga004.Multivector(4, inMv1.SampleCount);
                            outMv.Data = gpMvKv4Kv4(inMv1.Data, inMv2.Data);
                        otherwise
                            outMv = ga004.Multivector(-1, inMv1.SampleCount);

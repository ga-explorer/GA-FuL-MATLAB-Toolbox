...
classdef Multivector
    ...
    methods
        ...
        function outMv = getScalarPart(inMv)
            ...
            outMv = ga22.Multivector(0, inMv.SampleCount);
        ...
        function outMv = getVectorPart(inMv)
            ...
            outMv = ga22.Multivector(1, inMv.SampleCount);
        ...
        function outMv = getBivectorPart(inMv)
            ...
            outMv = ga22.Multivector(2, inMv.SampleCount);
        ...
        function outMv = getTrivectorPart(inMv)
            ...
            outMv = ga22.Multivector(3, inMv.SampleCount);
        ...
        function outMv = get4VectorPart(inMv)
            ...
            outMv = ga22.Multivector(4, inMv.SampleCount);
        ...
        function outMv = getKVectorPart(inMv, grade)
            ...
            outMv = ga22.Multivector(grade, inMv.SampleCount);
        ...
        function outMv = uplus(inMv)
            ...
            outMv = ga22.Multivector(inMv.Grade, inMv.SampleCount);
            outMv.Data = inMv.Data;
        end
        ...
        function outMv = plus(inMv1, inMv2)
            ...
            if (inMv1.Grade == inMv2.Grade)
                outMv = ga22.Multivector(inMv1.Grade, inMv1.SampleCount);
                outMv.Data = inMv1.Data + inMv2.Data;
            else
                outMv = ga22.Multivector(-1, inMv1.SampleCount);
        ...
        function outMv = sp(inMv1, inMv2)
            ...
            switch inMv1.Grade
                case 0
                    switch inMv2.Grade
                        case 0
                            outMv = ga22.Multivector(0, inMv1.SampleCount);
            ...
            switch inMv1.Grade
                case 0
                    switch inMv2.Grade
                        ...
                        case 2
                            outMv = ga22.Multivector(2, inMv1.SampleCount);
                            outMv.Data = opKv0Kv2Kv2(inMv1.Data, inMv2.Data);
                        case 3
                            outMv = ga22.Multivector(3, inMv1.SampleCount);
                            outMv.Data = opKv0Kv3Kv3(inMv1.Data, inMv2.Data);
                        case 4
                            outMv = ga22.Multivector(4, inMv1.SampleCount);

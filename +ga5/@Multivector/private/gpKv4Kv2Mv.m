function outMv = gpKv4Kv2Mv(inMv1, inMv2)
    ...
    outMv(7,:) = -inMv1(1,:) .* inMv2(6,:) - inMv1(2,:) .* inMv2(9,:) - inMv1(3,:) .* inMv2(10,:);
    outMv(8,:) = inMv1(1,:) .* inMv2(5,:) + inMv1(2,:) .* inMv2(8,:) - inMv1(4,:) .* inMv2(10,:);
    outMv(9,:) = -inMv1(1,:) .* inMv2(4,:) - inMv1(2,:) .* inMv2(7,:) - inMv1(5,:) .* inMv2(10,:);
    outMv(10,:) = -inMv1(1,:) .* inMv2(3,:) + inMv1(3,:) .* inMv2(8,:) + inMv1(4,:) .* inMv2(9,:);
    outMv(11,:) = inMv1(1,:) .* inMv2(2,:) - inMv1(3,:) .* inMv2(7,:) + inMv1(5,:) .* inMv2(9,:);
    outMv(12,:) = -inMv1(1,:) .* inMv2(1,:) - inMv1(4,:) .* inMv2(7,:) - inMv1(5,:) .* inMv2(8,:);
    ...
    outMv(27,:) = -inMv1(2,:) .* inMv2(10,:) + inMv1(3,:) .* inMv2(9,:) - inMv1(4,:) .* inMv2(8,:) + inMv1(5,:) .* inMv2(7,:);

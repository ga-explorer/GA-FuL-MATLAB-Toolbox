...
function outMv = lcpMvMvMv(inMv1, inMv2)
    ...
    outMv(4,:) = inMv1(1,:) .* inMv2(4,:) + inMv1(3,:) .* inMv2(8,:) - inMv1(5,:) .* inMv2(11,:) + inMv1(10,:) .* inMv2(15,:);
    outMv(5,:) = inMv1(1,:) .* inMv2(5,:) + inMv1(3,:) .* inMv2(10,:) + inMv1(4,:) .* inMv2(11,:) - inMv1(8,:) .* inMv2(15,:);
    ...
    outMv(11,:) = inMv1(1,:) .* inMv2(11,:) + inMv1(3,:) .* inMv2(15,:);

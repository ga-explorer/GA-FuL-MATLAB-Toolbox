...
classdef Multivector
    ...
    methods
        ...
        function outMv = getVectorPart(inMv)
            ...
            outMv = ga003.Multivector(1, inMv.SampleCount);
        ...
        function outMv = getBivectorPart(inMv)
            ...
            outMv = ga003.Multivector(2, inMv.SampleCount);
        ...
        function outMv = getKVectorPart(inMv, grade)
            ...
            outMv = ga003.Multivector(grade, inMv.SampleCount);
        ...
        function outMv = uplus(inMv)
            ...
            outMv = ga003.Multivector(inMv.Grade, inMv.SampleCount);
            outMv.Data = inMv.Data;
        end
        ...
        function outMv = unDual(inMv)
            ...
            switch inMv1.Grade
                ...
                otherwise
                    outMv = ga003.Multivector(3, inMv.SampleCount);
                    outMv.Data = unDualMvKv3(inMv.Data);
            end
        ...
        function outMv = plus(inMv1, inMv2)
            ...
            if (inMv1.Grade == inMv2.Grade)
                outMv = ga003.Multivector(inMv1.Grade, inMv1.SampleCount);
                outMv.Data = inMv1.Data + inMv2.Data;
            else
                outMv = ga003.Multivector(-1, inMv1.SampleCount);
        ...
        function outMv = sp(inMv1, inMv2)
            ...
            switch inMv1.Grade
                case 0
                    switch inMv2.Grade
                        case 0
                            outMv = ga003.Multivector(0, inMv1.SampleCount);
            ...
            switch inMv1.Grade
                case 0
                    switch inMv2.Grade
                        ...
                        case 2
                            outMv = ga003.Multivector(2, inMv1.SampleCount);
                            outMv.Data = opKv0Kv2Kv2(inMv1.Data, inMv2.Data);
                        case 3
                            outMv = ga003.Multivector(3, inMv1.SampleCount);
            ...
            switch inMv1.Grade
                ...
                case 1
                    switch inMv2.Grade
                        ...
                        case 3
                            outMv = ga003.Multivector(0, inMv1.SampleCount);
                            outMv.Data = gpKv1Kv3Kv0(inMv1.Data, inMv2.Data);
                        otherwise
                            outMv = ga003.Multivector(-1, inMv1.SampleCount);
                ...
                case 3
                    switch inMv2.Grade
                        ...
                        case 1
                            outMv = ga003.Multivector(0, inMv1.SampleCount);
                            outMv.Data = gpKv3Kv1Kv0(inMv1.Data, inMv2.Data);
                        case 2
                            outMv = ga003.Multivector(0, inMv1.SampleCount);
                        ...
                        otherwise
                            outMv = ga003.Multivector(3, inMv1.SampleCount);
                            outMv.Data = gpKv3MvKv3(inMv1.Data, inMv2.Data);
                    end
                ...
                otherwise
                    switch inMv2.Grade
                        ...
                        case 3
                            outMv = ga003.Multivector(3, inMv1.SampleCount);
                            outMv.Data = gpMvKv3Kv3(inMv1.Data, inMv2.Data);
                        otherwise
                            outMv = ga003.Multivector(-1, inMv1.SampleCount);

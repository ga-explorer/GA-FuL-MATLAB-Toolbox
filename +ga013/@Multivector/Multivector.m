    ...
    methods
        ...
        function outMv = mtimes(inMv, inScalar)
            ...
            elseif (inScalarSize(1) == 1 && inScalarSize(2) == inMv.SampleCount)
                outMv = ga013.Multivector(inMv.Grade, inMv.Data .* repmat(inScalar, [inMv.ScalarCount, 1]));
            else
        ...
        function outText = getLaTeX(inMv)
            ...
            switch inMv.Grade
                case 0
                    basisText = "";
                case 1
                    basisText = ["\bm{e}_{-}"; "\bm{e}_{01}"; "\bm{e}_{02}"; "\bm{e}_{03}"];
                case 2
                    basisText = ["\bm{e}_{-,01}"; "\bm{e}_{-,02}"; "\bm{e}_{01,02}"; "\bm{e}_{-,03}"; "\bm{e}_{01,03}"; "\bm{e}_{02,03}"];
                case 3
                    basisText = ["\bm{e}_{-,01,02}"; "\bm{e}_{-,01,03}"; "\bm{e}_{-,02,03}"; "\bm{e}_{01,02,03}"];
                case 4
                    basisText = "\bm{e}_{-,01,02,03}";
                otherwise
                    basisText = [""; "\bm{e}_{-}"; "\bm{e}_{01}"; "\bm{e}_{02}"; "\bm{e}_{03}"; "\bm{e}_{-,01}"; "\bm{e}_{-,02}"; "\bm{e}_{01,02}"; "\bm{e}_{-,03}"; "\bm{e}_{01,03}"; "\bm{e}_{02,03}"; "\bm{e}_{-,01,02}"; "\bm{e}_{-,01,03}"; "\bm{e}_{-,02,03}"; "\bm{e}_{01,02,03}"; "\bm{e}_{-,01,02,03}"];
            end

function outMv = gpKv1Kv3Mv(inMv1, inMv2)
    ...
    outMv(7,:) = inMv1(4,:) .* inMv2(2,:) + inMv1(5,:) .* inMv2(5,:);
    outMv(8,:) = inMv1(2,:) .* inMv2(1,:) + inMv1(4,:) .* inMv2(3,:) + inMv1(5,:) .* inMv2(6,:);
    outMv(9,:) = -inMv1(1,:) .* inMv2(1,:) + inMv1(4,:) .* inMv2(4,:) + inMv1(5,:) .* inMv2(7,:);
    outMv(10,:) = inMv1(2,:) .* inMv2(2,:) + inMv1(5,:) .* inMv2(8,:);
    outMv(11,:) = -inMv1(1,:) .* inMv2(2,:) + inMv1(5,:) .* inMv2(9,:);
    outMv(12,:) = -inMv1(1,:) .* inMv2(3,:) - inMv1(2,:) .* inMv2(4,:) + inMv1(5,:) .* inMv2(10,:);
    outMv(13,:) = inMv1(2,:) .* inMv2(5,:) - inMv1(4,:) .* inMv2(8,:);
    outMv(14,:) = -inMv1(1,:) .* inMv2(5,:) - inMv1(4,:) .* inMv2(9,:);
    outMv(15,:) = -inMv1(1,:) .* inMv2(6,:) - inMv1(2,:) .* inMv2(7,:) - inMv1(4,:) .* inMv2(10,:);
    outMv(16,:) = -inMv1(1,:) .* inMv2(8,:) - inMv1(2,:) .* inMv2(9,:);

...
classdef Multivector
    ...
    methods
        ...
        function outMv = getScalarPart(inMv)
            ...
            outMv = ga03.Multivector(0, inMv.SampleCount);
        ...
        function outMv = getVectorPart(inMv)
            ...
            outMv = ga03.Multivector(1, inMv.SampleCount);
        ...
        function outMv = getBivectorPart(inMv)
            ...
            outMv = ga03.Multivector(2, inMv.SampleCount);
        ...
        function outMv = getTrivectorPart(inMv)
            ...
            outMv = ga03.Multivector(3, inMv.SampleCount);
        ...
        function outMv = getKVectorPart(inMv, grade)
            ...
            outMv = ga03.Multivector(grade, inMv.SampleCount);
        ...
        function outMv = uplus(inMv)
            ...
            outMv = ga03.Multivector(inMv.Grade, inMv.SampleCount);
            outMv.Data = inMv.Data;
        end
        ...
        function outMv = dual(inMv)
            ...
            switch inMv.Grade
                case 0
                    outMv = ga03.Multivector(3, inMv.SampleCount);
                    outMv.Data = dualKv0Kv3(inMv.Data);
                case 1
                    outMv = ga03.Multivector(2, inMv.SampleCount);
                    outMv.Data = dualKv1Kv2(inMv.Data);
                case 2
                    outMv = ga03.Multivector(1, inMv.SampleCount);
                    outMv.Data = dualKv2Kv1(inMv.Data);
                case 3
                    outMv = ga03.Multivector(0, inMv.SampleCount);
                    outMv.Data = dualKv3Kv0(inMv.Data);
                otherwise
                    outMv = ga03.Multivector(-1, inMv.SampleCount);
        ...
        function outMv = plus(inMv1, inMv2)
            ...
            if (inMv1.Grade == inMv2.Grade)
                outMv = ga03.Multivector(inMv1.Grade, inMv1.SampleCount);
                outMv.Data = inMv1.Data + inMv2.Data;
            else
                outMv = ga03.Multivector(-1, inMv1.SampleCount);
        ...
        function outMv = sp(inMv1, inMv2)
            ...
            switch inMv1.Grade
                case 0
                    switch inMv2.Grade
                        case 0
                            outMv = ga03.Multivector(0, inMv1.SampleCount);
            ...
            switch inMv1.Grade
                case 0
                    switch inMv2.Grade
                        ...
                        case 2
                            outMv = ga03.Multivector(2, inMv1.SampleCount);
                            outMv.Data = opKv0Kv2Kv2(inMv1.Data, inMv2.Data);
                        case 3
                            outMv = ga03.Multivector(3, inMv1.SampleCount);

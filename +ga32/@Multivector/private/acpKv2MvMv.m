...
function outMv = acpKv2MvMv(inMv1, inMv2)
    ...
    outMv(2,:) = inMv1(3,:) .* inMv2(17,:) + inMv1(5,:) .* inMv2(18,:) - inMv1(6,:) .* inMv2(19,:) + inMv1(8,:) .* inMv2(21,:) - inMv1(9,:) .* inMv2(22,:) - inMv1(10,:) .* inMv2(24,:);
    outMv(3,:) = -inMv1(2,:) .* inMv2(17,:) - inMv1(4,:) .* inMv2(18,:) - inMv1(6,:) .* inMv2(20,:) - inMv1(7,:) .* inMv2(21,:) - inMv1(9,:) .* inMv2(23,:) - inMv1(10,:) .* inMv2(25,:);
    outMv(4,:) = -inMv1(1,:) .* inMv2(17,:) - inMv1(4,:) .* inMv2(19,:) - inMv1(5,:) .* inMv2(20,:) - inMv1(7,:) .* inMv2(22,:) - inMv1(8,:) .* inMv2(23,:) - inMv1(10,:) .* inMv2(26,:);
    outMv(5,:) = -inMv1(1,:) .* inMv2(18,:) + inMv1(2,:) .* inMv2(19,:) + inMv1(3,:) .* inMv2(20,:) - inMv1(7,:) .* inMv2(24,:) - inMv1(8,:) .* inMv2(25,:) + inMv1(9,:) .* inMv2(26,:);
    outMv(6,:) = -inMv1(1,:) .* inMv2(21,:) + inMv1(2,:) .* inMv2(22,:) + inMv1(3,:) .* inMv2(23,:) + inMv1(4,:) .* inMv2(24,:) + inMv1(5,:) .* inMv2(25,:) - inMv1(6,:) .* inMv2(26,:);
    ...
    outMv(17,:) = inMv1(1,:) .* inMv2(4,:) - inMv1(2,:) .* inMv2(3,:) + inMv1(3,:) .* inMv2(2,:) - inMv1(10,:) .* inMv2(32,:);
    outMv(18,:) = inMv1(1,:) .* inMv2(5,:) - inMv1(4,:) .* inMv2(3,:) + inMv1(5,:) .* inMv2(2,:) + inMv1(9,:) .* inMv2(32,:);
    outMv(19,:) = inMv1(2,:) .* inMv2(5,:) - inMv1(4,:) .* inMv2(4,:) + inMv1(6,:) .* inMv2(2,:) + inMv1(8,:) .* inMv2(32,:);
    outMv(20,:) = inMv1(3,:) .* inMv2(5,:) - inMv1(5,:) .* inMv2(4,:) + inMv1(6,:) .* inMv2(3,:) - inMv1(7,:) .* inMv2(32,:);
    outMv(21,:) = inMv1(1,:) .* inMv2(6,:) - inMv1(6,:) .* inMv2(32,:) - inMv1(7,:) .* inMv2(3,:) + inMv1(8,:) .* inMv2(2,:);
    outMv(22,:) = inMv1(2,:) .* inMv2(6,:) - inMv1(5,:) .* inMv2(32,:) - inMv1(7,:) .* inMv2(4,:) + inMv1(9,:) .* inMv2(2,:);
    outMv(23,:) = inMv1(3,:) .* inMv2(6,:) + inMv1(4,:) .* inMv2(32,:) - inMv1(8,:) .* inMv2(4,:) + inMv1(9,:) .* inMv2(3,:);
    outMv(24,:) = inMv1(3,:) .* inMv2(32,:) + inMv1(4,:) .* inMv2(6,:) - inMv1(7,:) .* inMv2(5,:) + inMv1(10,:) .* inMv2(2,:);
    outMv(25,:) = -inMv1(2,:) .* inMv2(32,:) + inMv1(5,:) .* inMv2(6,:) - inMv1(8,:) .* inMv2(5,:) + inMv1(10,:) .* inMv2(3,:);
    outMv(26,:) = -inMv1(1,:) .* inMv2(32,:) + inMv1(6,:) .* inMv2(6,:) - inMv1(9,:) .* inMv2(5,:) + inMv1(10,:) .* inMv2(4,:);
